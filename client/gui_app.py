...
class Frame(tk.Frame):
    ...
    def campos_pelicula(self):
        ...
        self.label_duracion.grid(row=1,column=0,padx=0,pady=10)
        
        
        self.label_genero=tk.Label(self,text='Genero: ')
        self.label_genero.config(font=('Arial',12,'bold'))
        self.label_genero.grid(row=2,column=0,padx=0,pady=10)
        ...
        self.boton_cancelar.config(width=20, font=('Arial',12,'bold'),fg='#DAD5D6',bg='#E15370',cursor='hand2',activebackground='#E15370')
    ...
    def tabla_pelicias(self):
        ...
        #Scrollbar para la tabla si exce 10 registros
        ...
        self.boton_eliminar.config(width=20, font=('Arial',12,'bold'),fg='#DAD5D6',bg='#E15370',cursor='hand2',activebackground='#E15370')
        self.boton_eliminar.grid(row=5,column=1,padx=10,pady=10)
        
    def editar_datos(self):
        try:
            self.id_pelicula=self.table.item(self.table.selection())['text']
            self.nombre_pelicula=self.table.item(
            self.table.selection())['values'][0]
            self.duracion_pelicula=self.table.item(
            self.table.selection())['values'][1]
            self.genero_pelicula = self.table.item(
            ...
            mensaje ="No ha seleccionado ningpun registro"
    ...
    def eliminar_datos(self):
        try:
            ...
            mensaje ="No ha Eliminado ningpun registro"
            messagebox.showerror(titulo,mensaje)
